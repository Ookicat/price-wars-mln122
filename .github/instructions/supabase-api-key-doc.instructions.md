---
description: This file describes the different types of API keys in Supabase, their use cases, security considerations, and best practices for handling them.
